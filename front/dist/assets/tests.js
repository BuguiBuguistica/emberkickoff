  ...
  (0, _qunit.module)('Integration | Component | conference-card', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      const item = {
        ...
        head_of_opc: {
          id: "1a88156e-c660-43cb-92a9-e0104f93c708",
          first_name: "Alejandro",
          last_name: "1116"
        },
        id: 11,
        level: {
          id: "f207efb7-24f0-48d4-9c4-948504948901",
          name: "L2"
        },
        number_of_employees: 4,
        responsible_hr: {
          id: "b9b7ba70-783b-317e-9998-dc4dd82eb3f4",
          first_name: "Jane",
          last_name: "1116"
        },
      ...
      this.set('item', item); // Template block usage:

      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "oHPxURhe",
        "block": "{\"symbols\":[],\"statements\":[[1,[27,\"conference-card\",null,[[\"item\"],[[23,[\"item\"]]]]],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define("front/tests/integration/components/lala-", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";

  (0, _qunit.module)('Integration | Component | lala', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', async function (assert) {
      // Set any properties with this.set('myProperty', 'value');
      // Handle any actions with this.set('myAction', function(val) { ... });
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "WpRMb+2l",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"lala\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "TJ6mQs5e",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"lala\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define("front/tests/lint/app.lint-test", [], function () {
  ...
  QUnit.test('components/lala.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/lala.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/styles-guide.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/styles-guide.js should pass ESLint\n\n');
  });
...
define("front/tests/lint/templates.template.lint-test", [], function () {
  ...
  QUnit.test('front/templates/components/lala.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'front/templates/components/lala.hbs should pass TemplateLint.\n\n');
  });
  ...
  QUnit.test('front/templates/styles-guide.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'front/templates/styles-guide.hbs should pass TemplateLint.\n\n');
  });
});
define("front/tests/lint/tests.lint-test", [], function () {
  ...
  QUnit.test('integration/components/lala-.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/lala-.js should pass ESLint\n\n');
  });
...
define("front/tests/unit/services/people-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  ...
  (0, _qunit.module)('Unit | Service | people', function (hooks) {
    ...
    (0, _qunit.test)('it exists', function (assert) {
      let service = this.owner.lookup('service:peopleService');
      assert.ok(service);
    });
  });
});
